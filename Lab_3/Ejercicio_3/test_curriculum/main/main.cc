/*
 * test_curriculum — Inferencia con modelo Curriculum (sin KD)
...
static const char *TAG = "curriculum";

/* ── Modelo embebido (EMBED_FILES en CMakeLists) ─────────────────────────── */
extern const uint8_t model_start[] asm("_binary_curriculum_int8_tflite_start");
extern const uint8_t model_end[]   asm("_binary_curriculum_int8_tflite_end");
...
{
    ESP_LOGI(TAG, "Iniciando test_curriculum...");
