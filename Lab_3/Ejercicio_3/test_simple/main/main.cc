/*
 * test_simple — Inferencia con modelo Simple (sin KD)
...
extern const uint8_t model_start[] asm("_binary_simple_int8_tflite_start");
extern const uint8_t model_end[]   asm("_binary_simple_int8_tflite_end");
...
{
    ESP_LOGI(TAG, "Iniciando test_simple...");
