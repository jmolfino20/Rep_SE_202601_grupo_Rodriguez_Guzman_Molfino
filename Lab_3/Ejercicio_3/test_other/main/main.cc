...
extern const uint8_t model_start[] asm("_binary_best_model_v2_tflite_start");
extern const uint8_t model_end[]   asm("_binary_best_model_v2_tflite_end");
