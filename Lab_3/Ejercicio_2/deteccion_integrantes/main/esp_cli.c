...
extern const uint8_t molfino_start[]   asm("_binary_molfino_start");
extern const uint8_t rai_start[]   asm("_binary_rai_start");
extern const uint8_t rodri_start[]   asm("_binary_rodri_start");
#endif
...
int esp_cli_register_inference_command() {
    esp_console_cmd_t command = {
        ...
        .help = "detect_image <image_number>"
                "Note: image numbers ranging from 0 - 12 only are valid",
...
static void image_database_init()
{
    ...
    image_database[10] = (uint8_t *) molfino_start;
    image_database[11] = (uint8_t *) rai_start;
    image_database[12] = (uint8_t *) rodri_start;
#endif
}
